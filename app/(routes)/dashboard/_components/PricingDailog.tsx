    ...
    >
      ...
      <ul className="mt-6 space-y-2">
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700">  Includes all features available </span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Unlock advanced features </span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700">  Access to workshops, webinars </span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700">  Discounts on Additional Services </span>
        </li>
      </ul>

      <Link
        href="https://github.com/Amitpawar88/"
    ...
    <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
      ...
      <ul className="mt-6 space-y-2">
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Limited Access to DraftVistra </span>
        </li>
